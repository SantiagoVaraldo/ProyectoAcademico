//--------------------------------------------------------------------------------
// <copyright file="FilterButtonSound.cs" company="Universidad Católica del Uruguay">
...
namespace Library
{
    ...
    public class FilterButtonSound : IFilterConditional
    {
        ...
        public Visitor Filter(Tag tag)
        {
            ...
            {
                this.Result = true;
                Visitor visitorButtonSound = new VisitorButtonSound(tag);
                return visitorButtonSound;
            }
            else
            {
                this.Result = false;
